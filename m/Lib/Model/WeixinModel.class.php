...
class WeixinModel extends CommonModel {
	...
	protected $_validate = array(
            ...
            array('pubaccount','require','名称必填'),
            array('logo','checklogo','封面必须上传！',1,'callback'),
            array('qrcode','checkqrcode','二维码必须上传！',1,'callback'),
            array('content','require','帐号介绍必填'),
            //array('pubaccount','','帐号名称已经存在',0,'unique',self::MODEL_INSERT),
