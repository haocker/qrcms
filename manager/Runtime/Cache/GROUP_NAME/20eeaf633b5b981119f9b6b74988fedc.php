<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><title>『YuFuCMS管理平台』By YuFuCMS </title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link rel='stylesheet' type="text/css" href="../Public/css/style.css" /><base target="main" /></head><body><div class="top"><div class="logo"><a href="/">QRCMS管理平台</a></div><div class="info">                欢迎您！[<?php echo (session('loginUserName')); ?>]
