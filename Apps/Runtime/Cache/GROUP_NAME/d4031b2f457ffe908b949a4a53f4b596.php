<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title><?php echo ($title); ?>-<?php echo ($sitename); ?></title><meta name="keywords" content="<?php echo ($keywords); ?>" /><meta name="description" content="<?php echo ($description); ?>" /><script src="../Public/js/device.min.js" type="text/javascript"></script><script src="../Public/js/jquery.min.js" type="text/javascript"></script><script src="../Public/js/jquery.cookie.js" type="text/javascript"></script><script src="../Public/js/com.js" type="text/javascript"></script><script src="../Public/js/jquery.lazyload.min.js" type="text/javascript"></script><link rel="stylesheet" href="../Public/css/blue.css" /><link rel="stylesheet" type="text/css" href="../Public/css/style.css" /><link rel="stylesheet" href="../Public/css/swiper.min.css"><script type="text/javascript" src="../Public/js/swiper.min.js"></script><script>        if(device.mobile()){
        ...
        $(".follow_tip_link").hover(function() {
            $(".record i").toggleClass('wxICON_1_rotate');
                    ...
                    </a></li><?php if(is_array($nav_list)): $i = 0; $__LIST__ = $nav_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(empty($vo["sub_nav"])): ?><li><i></i><a href="<?php echo ($vo["url"]); ?>" id="nav_<?php echo ($vo["id"]); ?>"><?php echo ($vo["catname"]); ?></a></li><?php else: ?><li><i></i><a href="<?php echo ($vo["url"]); ?>" class=><?php echo ($vo["catname"]); ?><i class="icon-down"></i></a><div style="z-index: 999; display: none;"><?php if(is_array($vo["sub_nav"])): $i = 0; $__LIST__ = array_slice($vo["sub_nav"],1,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i; if(($key) == "1"): ?><a href="<?php echo ($vo["url"]); ?>" class="catalog">所有分类</a><?php endif; ?><a href="<?php echo ($sub["url"]); ?>"  class="catalog"><?php echo ($sub["catname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?></div></li><?php endif; endforeach; endif; else: echo "" ;endif; ?><li class="Release" style="float:right;"><span class="fl weixinqunICON wxICON_4"></span><a href="<?php echo U('Member/add');?>" id="add_group">发布微信群</a><!-- <a href="/user_center/group" class="diag" id="add_group">发布微信群</a> --><span class="fr weixinqunICON wxICON_5"></span></li></ul></div></div></div><link href="../Public/css/style_zixun.css" rel="stylesheet" /><div class="container" style=" background:#fff; border-bottom:1px solid #ccc;"><div class="w1200"><div class="city_nav_inp title"><span class="title_dqwx" style="float: left"><?php echo ($data["catname"]); ?></span><div class="Rel_btn Rel_gjqun" style="margin-top: 30px;"><span class="weixinqunICON wxICON_7"></span><a href="JavaScript:alert('请联系客服')" class="user-center">                    我要投稿
                </a></div></div></div></div><div class="container"><div class="w1200 clearfix pb10"><?php if(empty($catid)): $cat = $parentcatid; else: $cat = $catid; endif; ?><div class="assort-content bg clearfix mt20"><div class="d2"><span class="fl"><strong>类型:</strong></span><ul class="expend" id="citybox"><li <?php if(($parentcatid == '') and ($catid == '')): ?>class="active"<?php else: ?>class=""<?php endif; ?>><a href="<?php echo U('Article/index',array('id'=>55));?>">全部</a></li><?php if(is_array($categorylist)): $i = 0; $__LIST__ = $categorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category2): $mod = ($i % 2 );++$i; if(($category2['level']) == "2"): ?><li <?php if(($parentcatid == $category2['id'])): ?>class="active"<?php else: ?>class=""<?php endif; ?>><a  href="<?php echo U('Article/index',array('id'=>$category2['id']));?>" title="<?php echo ($category2['catname']); ?>" ><?php echo ($category2['catname']); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?></ul></div></div></div></div><div class="H_zixun Pub mt20"><div class="zz_conts"><ul><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><div class="zz_nr"><a href="<?php echo U('Article/show',array('id'=>$vo['id']));?>" target="_blank"><img src="<?php if(empty($vo["thumb"])): ?>../Public/images/nopic.gif<?php else: ?>__ROOT__/Uploads<?php echo ($vo["thumb"]); endif; ?>" alt="<?php echo ($vo["title"]); ?>"></a><strong class="ellips"><a href="<?php echo U('Article/show',array('id'=>$vo['id']));?>" target="_blank"><?php echo ($vo["title"]); ?></a></strong><p style="width: 369px;height:107px; overflow:hidden"><?php echo (msubstr(strip_tags($vo["content"]),0,95)); ?><a href="<?php echo U('Article/show',array('id'=>$vo['id']));?>" target="_blank">[详细]</a></p><p style="color:#9a9a9a;" class="share_detail"><font class="fl">阅读 <?php echo ($vo['hits']*175); ?></font><font class="ml20">发布时间：<?php echo (date('Y-m-d H:i',$vo["create_time"])); ?></font><font class="fr"><a href="#"><img src="../Public/images/fen.png" alt="朋友圈二维码">朋友圈</a><span class="list_share_code" style="display: none;"><img src="http://check.weixinqun.com/get_qrcode?data=<?php echo U('Article/show',array('id'=>$vo['id']),'',false,true);?>" alt="二维码"><span class="share_py_txt">发到朋友圈</span></span></font></p><div class="clr"></div></div></li><?php endforeach; endif; else: echo "" ;endif; ?><div class="clr"></div></ul><div class="pageNo vm center"><?php echo ($page); ?></div></div></div><script type="text/javascript">    $(".share_detail a").hover(function () {
        $(this).siblings(".list_share_code").show();
    }, function () {
